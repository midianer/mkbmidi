...
struct t_song ComeHome;
struct t_splits ComeHome0;
struct t_splits *ComeHomeList[] = 
{
	&ComeHome0, NULL};
	

struct t_song ComeHome={ "Coming Home",
	0, 81,1,21,&ComeHomeList[0],NULL,
...
struct t_splits ComeHome0={
    ...
    0,   0, 55, 24,  Chan1,  127, 1,VolCtr2,InChan0, /* JV1080 Bank C */
    0,  56,127,  0,  Chan12, 127, 1,VolCtr1,InChan0,    /*  El. Piano */
    0,  56,127,  0,  Chan13, 127, 1,VolCtr1,InChan0,    /*  El. Piano */
    1,  56,127, -24,  Chan2,  127, 1,VolCtr1,InChan0,    /*  Ak. Piano */
