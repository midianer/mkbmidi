...
PATCH_STR Patch_Jugement1;



/* -------- Jugement ---------------------------------------------------- */

struct t_song Jugement;

PERF_STR Perf_Jugement;


struct t_song Jugement;
struct t_splits Jugement0;
struct t_splits *JugementList[] = 
{
	&Jugement0, NULL};


struct t_song Jugement={ "Jugement",
	0, 81,1,3,&JugementList[0],NULL,
	NULL,0l,
	&Patch_Jugement1,0x02010000l,
...
struct t_splits Jugement0={
    ...
    1,   C3,C8,   12,  Chan0, 100, 0,VolCtr2,InChan0,
    1,   A0,H2,   36,  Chan1, 127, 0,VolCtr2,InChan0,
    0,   A0,H2,    0,  Chan2, 127, 0,VolCtr2,InChan0,
...
t_splits_jv1080 Jugement_Purple_SplitList={
	"Jugement", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      ...
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan2, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan3, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 1, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan4, 127, SustModeRot, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan5, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan6,  90, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan7, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan8, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan9, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chana, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chanb, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chanc, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chand, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chane, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chanf, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } 
      },
...
t_splits_jv1080 DernierPas_Auger_SplitList={
	"DernierPas", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan0, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 1, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan1, 127, SustModeRot, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan2, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan3, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
...
t_splits_jv1080 DernierMot_Auger_SplitList={
	"DernierMot", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan0, 127, SustModeNop, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
      { 0, InChan0, 0, 0, "NoName", A0,C8,   0,  Chan1, 127, SustModeRot, VolCtr2, ModulationOff, 0, MNUMBER_JV1080_SPLIT } ,
...
t_instrument Juge_DernierPas_DernierMot_SplitList[] = 
{
	{  1, (t_splits_jv1080 *)&Jugement_Purple_SplitList  , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
	{  1, (t_splits_jv1080 *)&DernierPas_Auger_SplitList , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&DernierMot_Auger_SplitList , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
