...
struct t_song Talli;
struct t_splits Talli0;
struct t_splits *TalliList[] = 
{
	&Talli0, NULL};
	

struct t_song Talli={ "Talli",
	0, 81,1,21,&TalliList[0],NULL,
	NULL,0l,NULL,0l,NULL,0l,NULL,0l,NULL,0l,
	NULL,0l,NULL,0l,NULL,0l,NULL,0l,NULL,0l,
    1, 81,2,60,  Chan0,	/* JV1080 Bank C */
    0, 81,2,50,  Chan1,	/* JV1080 Bank C */
    0, 81,3,5,   Chan2, 
    0, 81,3,4,   Chan3,
    0, 81,0,0,   Chan4,
    0, 81,0,0,   Chan5,
