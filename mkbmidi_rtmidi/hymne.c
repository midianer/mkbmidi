...
struct t_splits Hymne0;
struct t_splits Hymne1;
struct t_splits Hymne2;
struct t_splits Hymne3;
struct t_splits Hymne4;

PERF_STR Perf_Hymne;

PATCH_STR Patch_Hymne;
PATCH_STR Patch_HY_GlassyPad;
PATCH_STR Patch_HY_Overtone;
PATCH_STR Patch_HY_Analog2;
PATCH_STR Patch_HY_Analog;
PATCH_STR Patch_StikyFunk;

struct t_splits *HymneList[] = 
{
	&Hymne4, &Hymne1, &Hymne0, &Hymne3, &Hymne1, &Hymne2, NULL};

struct t_song Hymne={ "Hymne",
	0, 81,1,21,&HymneList[0],
	&Perf_Hymne,
	&Patch_Hymne,		0x02000000l,     /* Fanfare */
	&Patch_HY_Analog2,		0x02020000l,
	&Patch_StikyFunk,	0x02030000l,
/*	&Patch_Hymne,		0x02030000l,   */  /* Moog */
	&Patch_HY_GlassyPad,	0x02060000l,
	&Patch_HY_Overtone,	0x02070000l,
...
/* PATCH fÅr HYMNE mit Effekte aus Preset C15 */
PATCH_STR Patch_HY_Analog = {
/* Patch Common */
0x03000000l, 0x00000048l,
/*   NAME   */
