...
t_splits_jv1080 Moeurs_Strings={
   "Split0", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      {    1, InChan0, 0, 0, "NoName",  A0,H1,    0,  Chan5, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,H1,  -12,  Chan5, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  C2,C8,   12,  Chan1, 115, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      ...
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan0, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
...
t_splits_jv1080 Moeurs_StringsOrgel={
   "Moeur_Purple", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      {    0, InChan0, 0, 0, "NoName",  A0,C8,    0,  Chan0, 110, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,C8,    0,  Chan1, 110, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,C8,   12,  Chan2,  90, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan3, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan4, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
...
t_splits_jv1080 Moeurs_StringsOboe={
   "Moeur_Oboe", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      {    1, InChan0, 0, 0, "NoName",  A0,F5,    0,  Chan0,  70, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,F5,    0,  Chan1,  80, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,F5,   12,  Chan1,  60, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan3, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  G5,C8,  -12,  Chan4, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan5, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan6, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan7, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan8, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
...
t_splits_jv1080 Moeurs_Cathedrale={
   "Moeur_Cath", NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {  
      {    0, InChan0, 0, 0, "NoName",  A0,C8,    0,  Chan0, 110, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,C8,    0,  Chan1, 110, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    1, InChan0, 0, 0, "NoName",  A0,C8,    0,  Chan3,  90, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan3, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan4, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan5, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
      {    0, InChan0, 0, 0, "NoName",  A0,A0,    0,  Chan6, 127, 0,VolCtr2,ModulationOff, 0, MNUMBER_JV1080_SPLIT  } ,
...
t_instrument Moeurs_xxyyList[] = 
{
   {  1, (t_splits_jv1080 *)&Moeurs_Strings       , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_StringsOrgel  , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_Strings       , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_StringsOrgel  , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_Strings       , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_StringsOrgel  , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_StringsOboe   , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_StringsOrgel  , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_Cathedrale    , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
   {  1, (t_splits_jv1080 *)&Moeurs_Strings       , (t_splits_jx8p *)NULL , (t_splits_z4 *)NULL },
...
t_song_xxyy Moeurs_xxyySong = { 
   ...
   "JV",
   (t_instrument*)&Moeurs_xxyyList,
   { 3 }, { 0xffffffffUL }, { 0xffffffffUL }, 
};



/*  PATCH_STR Patch_Moeurs1;  */

/* -------- Moeurs ---------------------------------------------------- */


PATCH_STR Patch_MoeursString;
PATCH_STR Patch_Oboe;
...
"Moeurs      ",
   ...
   },
   {
       ...
       {    127, 46, 20,127,  0,127,127, 45,127,  0,  0,127, 32,103,  0, 86},
        /*RevSndLev-*/
       {    127, 59, 20, 72,100,103, 70,116,127, 70,127,127,127,127,127,127},
        /*RecPgmChg-*/
...
/* Oboe */
struct t_splits Moeurs2={
	NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
   {
      {     1,   A0,H2,  0,  Chan0, 127, 0,VolCtr2,InChan0} ,
      {     1,   C2,H3, 24,  Chan1, 115, 0,VolCtr2,InChan0} ,
      {     1,   C4,F5, 12,  Chan1, 127, 0,VolCtr2,InChan0} ,
      {     1,   C4,F5, 24,  Chan1, 127, 0,VolCtr2,InChan0} ,
      {     1,   G5,C8, -24,  Chan4, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,  0,  Chan5, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,  0,  Chan6, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,  0,  Chan7, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,  0,  Chan8, 127, 0,VolCtr2,InChan0} ,
...
/* Purple / Strings */
struct t_splits Moeurs3={
	NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
	{
      {     0,   A0,A0,   0,  Chan0, 127, 0,VolCtr2,InChan0} ,
      {     0,   A0,A0,   0,  Chan0, 127, 0,VolCtr2,InChan0} ,
      {     1,   G4,C8, -12,  Chan1, 127, 0,VolCtr2,InChan0} ,
      {     1,   G4,C8,   0,  Chan1, 127, 0,VolCtr2,InChan0} ,
      {     1,   A0,F4,   0,  Chan2, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,   0,  Chan5, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,   0,  Chan6, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,   0,  Chan7, 127, 0,VolCtr2,InChan0} ,
      {     0,   0,127,   0,  Chan8, 127, 0,VolCtr2,InChan0} ,
...
/* Purple / Strings */
struct t_splits Moeurs4={
	NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
    {
      {     0,   A0,A0,   0,  Chan0, 127, 0,VolCtr2,InChan0} ,
      {     0,   A0,A0,   0,  Chan0, 127, 0,VolCtr2,InChan0} ,
      {     1,   G4,C8,  12,  Chan1, 127, 0,VolCtr2,InChan0} ,
      {     1,   G4,C8,  24,  Chan1, 127, 0,VolCtr2,InChan0} ,
...
struct t_splits *MoeursList[] = 
{
	&Moeurs0,		/* String / String */ 
	&Moeurs3,       /* Purple */
	&Moeurs2,		/* String / Oboe */ 
	&Moeurs4,       /* String + Purple */ 
	&Moeurs1, 		/* Orgel */
	&Moeurs0, 
	NULL};


struct t_song Moeurs={ "Moeurs",
	0, 81,1,3,&MoeursList[0],
	&Perf_Moeurs,
{
{  NULL,0l},
{  &Patch_MoeursString,		0x02010000l},     /* String */
{  NULL,0l},
{  NULL,0l},
{  &Patch_Oboe,                0x02040000l},     /* Oboe   */
{  NULL,0l},
{  NULL,0l},
{  NULL,0l},
{  NULL,0l},
...
{      1, 81,0,55,  Chan2},  /* Purple Spin */
      { 1, 81,0,59,  Chan3 },  /* Cathedral */
      { 1, 81,1,102, Chan4 },    /* Oboe */
      { 0, 81,0,0,   Chan5 },
      { 0, 81,0,0,   Chan6 },
      { 0, 81,0,0,   Chan7 },
      { 0, 81,0,0,   Chan8 },
