...
struct t_song BonVoyage;

struct t_splits BonVoyage0;
struct t_splits BonVoyage1;
struct t_splits BonVoyage2;
struct t_splits BonVoyage3;
struct t_splits BonVoyage4;

PERF_STR Perf_BonVoyage;

PATCH_STR Patch_BonVoyage;
PATCH_STR Patch_BV_GlassyPad;
PATCH_STR Patch_BV_Overtone;
PATCH_STR Patch_BV_Analog2;
PATCH_STR Patch_Analog;
PATCH_STR Patch_BV_StikyFunk;

struct t_splits *BonVoyageList[] = 
{
	&BonVoyage4, &BonVoyage1, &BonVoyage0, &BonVoyage3, &BonVoyage1, &BonVoyage2, NULL};

struct t_song BonVoyage={ "BonVoyage",
	0, 81,1,21,&BonVoyageList[0],
	&Perf_BonVoyage,
	&Patch_BonVoyage,		0x02000000l,     /* Fanfare */
	&Patch_BV_Analog2,		0x02020000l,
	&Patch_BV_StikyFunk,	   0x02030000l,
/*	&Patch_BonVoyage,		0x02030000l,   */  /* Moog */
	&Patch_BV_GlassyPad,	0x02060000l,
	&Patch_BV_Overtone,	0x02070000l,
...
struct t_splits BonVoyage4={
	NULL, SPLITVAL, ALLNOTES_OFF, FULL_PERFCOMMON,
    0,   C2,C8,  0,  Chan0, 127, 1,VolCtr2, InChan0,
    0,   A0,C8, 12,  Chan1, 127, 1,VolCtr2, InChan0,
    1,   A0,C8,  0,  Chan2, 127, 0,VolCtr2, InChan0, /* Analog 2 */
    0,   A0,C8,  0,  Chan3, 127, 0,VolCtr2, InChan0,
    0,   A0,H4, 24,  Chan4, 127, 0,VolCtr2, InChan0,
    0,   C5,C8,-24,  Chan5, 127, 0,VolCtr2, InChan0,
...
/* PATCH fÅr BonVoyage mit Effekte aus Preset C15 */
PATCH_STR Patch_Analog = {
/* Patch Common */
0x03000000l, 0x00000048l,
/*   NAME   */
